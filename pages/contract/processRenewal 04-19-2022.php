            ...
            <div class="box box-primary">
                ...
                <form action="" id="dataProcessRenewal" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <h4><strong><?php echo "[$empId] ".ucwords(strtolower(utf8_encode($name))); ?></strong></h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="company_select" class="form-control inputSelect" style="display:none;" onchange="selectCompanyProduct(this.value)"></select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Promo Type</td>
                                ...
                                <tr class="companyDuration" <?php if ($row['type'] == "Seasonal" || $row['promo_department'] == "HOME AND FASHION" || $row['promo_department'] == "FIXRITE" || $row['promo_department'] == "EASY FIX"): echo ""; else : echo "style = 'display:none;'"; endif; ?>>
                                    <td><i class="text-red">*</i> Duration from Company</td>
                                    <td><?php if($row['company_duration'] == '0000-00-00' || $row['company_duration'] == ''): echo ""; else: echo date("M. d, Y", strtotime($row['company_duration'])); endif; ?></td>
                                    <td>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                            <input type="text" name="companyDuration" class="form-control datepicker" placeholder="mm/dd/yyyy" onchange="inputField(this.name)"></td>
                                        </div>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="startdate" class="form-control datepicker" placeholder="mm/dd/yyyy" onchange="inputStartdate()">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="eocdate" class="form-control datepicker" placeholder="mm/dd/yyyy" onchange="durationContract(this.value)">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                ...
                callback: function(button) {
                    if (button == 'OK'){
                        ...
                        $.ajax({
                            ...
                            data : { department:department, vendor:vendor },
                            success : function(data){
