<?php 
    ...
    $sql = mysql_query("SELECT name, startdate, eocdate, duration, emp_type, current_status, positionlevel, position, comments, remarks, promo_company, promo_department, company_duration, promo_type, type
                                FROM 
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form action="" id="dataProcessRenewal" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="company_select" class="form-control inputSelect" style="display:none;" onchange="inputField(this.name)"></select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Promo Type</td>
                                    ...
                                    <td>
                                        ...
                                        <select name="promoType_select" class="form-control inputSelect" style="display:none;" onchange="locateBunit(this.value)">
                                            <option value="STATION" <?php if($row['promo_type'] == "STATION"): echo "selected=''"; endif; ?>>STATION</option>
                                            <option value="ROVING" <?php if($row['promo_type'] == "ROVING"): echo "selected=''"; endif; ?>>ROVING</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <?php 
                                                    ...
                                                    while ($r = mysql_fetch_array($store)) { 
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td><input type="checkbox" name="<?php echo $r['bunit_field']; ?>" disabled="" <?php if($bunitNum > 0) { echo "checked=''"; } ?>></td>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <?php 
                                                        ...
                                                        while ($s = mysql_fetch_array($store)) { 
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input type="radio" disabled="" name="stations" <?php if($bunitNum > 0) { echo "checked=''"; } ?>></td>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <?php 
                                                        ...
                                                        while ($r = mysql_fetch_array($store)) { 
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input type="checkbox" class="checkedEnable" disabled="" id="check_<?php echo $counter; ?>" name="<?php echo $r['bunit_field']; ?>" value="<?php echo $r['bunit_id'].'/'.$r['bunit_field']; ?>" <?php if($bunitNum > 0) { echo "checked=''"; } ?> onclick="locateDeptR()"/></td>
                                                                <td><?php echo $r['bunit_name'];?></td>
                                                            </tr><?php 
                                                        }
                                                    ?>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <?php 
                                                        ...
                                                        while ($s = mysql_fetch_array($store)) { 
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input type="radio" class="checkedEnable" disabled="" name="station" id="radio_<?php echo $loop; ?>" value="<?php echo $s['bunit_id'].'/'.$s['bunit_field']; ?>" <?php if($bunitNum > 0) { echo "checked=''"; } ?> onclick="locateDeptS(this.value)"/></td>
                                                                <td><?php echo $s['bunit_name'];?></td>
                                                            </tr><?php 
                                                        }
                                                    ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="position_select" class="form-control inputSelect" style="display:none;" onchange="inputField(this.name)"></select>
                                </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="positionlevel_select" class="form-control inputSelect" style="display:none;"></select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Employee Type</td>
                                ...
                                <tr class="companyDuration" <?php if ($row['type'] == "Seasonal" || $row['promo_department'] == "HOME AND FASHION" || $row['promo_department'] == "FIXRITE"): echo ""; else : echo "style = 'display:none;'"; endif; ?>>
                                    <td><i class="text-red">*</i> Duration from Company</td>
                                    <td><?php if($row['company_duration']==0000-00-00): echo ""; else: echo date("M. d, Y", strtotime($row['company_duration'])); endif; ?></td>
                                    <td>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                            <input type="text" name="companyDuration" class="form-control datepicker" placeholder="mm/dd/yyyy" autocomplete="off" onchange="inputField(this.name)"></td>
                                        </div>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="startdate" class="form-control datepicker" placeholder="mm/dd/yyyy" autocomplete="off" onchange="inputStartdate()">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="eocdate" class="form-control datepicker" placeholder="mm/dd/yyyy" autocomplete="off" onchange="durationContract(this.value)">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
...
<script type="text/javascript">
        ...
        $.alert.open({
                ...
                callback: function(button) {
                    if (button == 'OK'){
                        ...
                        var positionLevel = $("[name = 'positionlevel']").val();
                        ...
                        $.ajax({
                            ...
                            data : { empId:empId, promoType:promoType, department:department },
                            success : function(data){
                        ...
                        $.ajax({
                            ...
                            success : function(data){
                                ...
                                $("[name='positionlevel_select']").html(data);
                            }
                        });
                ...
                callback: function(button) {
                    if (button == 'OK'){
                        ...
                        $.ajax({
                            ...
                            data : { empId:empId, promoType:promoType, recordNo:recordNo },
                            success : function(data){
    ...
    function chkDepartment(dept){
        ...
        if (dept == "HOME AND FASHION" || dept == "FIXRITE" || dept == "EASY FIX" || ((dept == "GROCERY" || dept == "FRESH MARKET" || dept == "SOD" || dept == "MEDICINE PLUS") && contractType == "Seasonal")) {
    ...
    function genPermit(){
        ...
        if (store == "" || dutyDays == "" || dutySched == "" || dayOff == "" || (specialSched != "" && specialDays == "")) {
            ...
            $.ajax({
                ...
                data : { empId:empId, recordNo:recordNo, store:store, dutyDays:dutyDays, dutySched:dutySched, specialSched:specialSched, specialDays:specialDays, dayOff:dayOff, cutOff:cutOff },
                success : function(data){
