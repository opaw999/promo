            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group"> <i class="text-red">*</i>
                        ...
                        <select name="position" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" disabled="" onchange="inputField(this.name)">
                            <option value=""> --Select-- </option>
                            <?php 
                                ...
                                while ($row = mysql_fetch_array($posSelect)) { ?>
                                    ...
                                    <option value="<?php echo $row['position']; ?>"><?php echo $row['position']; ?></option><?php
                                }
                            ?>
                        </select>
                    </div>
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    if (data[0].trim() == "Ok") {
                        ...
                        if(data[1].trim() == "blacklisted" || data[1].trim() == "Active"){
                            ...
                            $.ajax({
                                ...
                                data : { empId:empId[0].trim(), recProcess:recProcess, position:position },
                                success : function(data){
