...
<div id="uploadClearance" class="modal fade">
    <div class="modal-dialog modal-md">
        ...
        <form action="" id="dataUploadClearanceforTransferOutlet" method="post" enctype="multipart/form-data">
            <div class="modal-body">
...
<script type="text/javascript">
    ...
    function getEmpId(empId){
        ...
        $.ajax({
            type : "POST",
            url  : "functionquery.php?request=transferOutlet",
    ...
    function transferOutlet(code,empId,recordNo,field){
        ...
        if (code == "Transfer") {
            ...
            $.ajax({
                type : "POST",
                url  : "functionquery.php?request=uploadClearanceforTransferOutlet",
